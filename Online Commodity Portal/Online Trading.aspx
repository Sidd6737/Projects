<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="Online Trading.aspx.cs" Inherits="Internet" %>
    ...
    <div>
        <table style="width: 758px">
            ...
            <tr>
                ...
                <div id="tabsF">
  <ul>
    <li><a href="ADMIN Home.aspx" title="HOME"><span>HOME</span></a></li>
     <li><a href="ADMIN Online Price.aspx" title= "ONLINE PRICE"><span>ONLINE PRICE</span></a></li>
    <li><a href="ADMIN About US.aspx" title="ABOUT US"><span>ABOUT US</span></a></li>
    ...
    <li>&nbsp;</li></ul>
        ...
        <div id="menu3">
		    <ul>
			    <li><a href="Online Trading.aspx" title="Online Trading">Online Trding</a></li>			
            ...
            <tr>
                ...
                <td class="style1">
                    <asp:DropDownList ID="DropDownList1" runat="server" Height="16px" Width="205px">
                        <asp:ListItem>Jeera</asp:ListItem>
                        <asp:ListItem>Isbagul</asp:ListItem>
                        <asp:ListItem>Variyari</asp:ListItem>
                        <asp:ListItem>Tal</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
...
mso-ansi-language:EN-US;mso-fareast-language:EN-US;mso-bidi-language:AR-SA">Quantity</span></td>
                <td class="style1">
            ...
            <tr>
                <td class="style1">
                    Bank Name</td>
                <td class="style1">
                    <asp:DropDownList ID="DropDownList4" runat="server" Height="16px" Width="207px">

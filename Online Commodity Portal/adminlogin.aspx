...
<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="adminlogin.aspx.cs" Inherits="Default" %>
...
<body style="font-weight: bold">
    ...
    <div>
        ...
        <table style="width: 998px; left: 2px; position: absolute; top: 3px; height: 79px;">
            <tr>
                <td style="width: 251185px; height: 20px" colspan="3">
                    <asp:ImageMap ID="ImageMap1" runat="server" Height="109px" 
                        ImageUrl="~/Imanges2/index_02.gif" Width="1015px">
                    </asp:ImageMap>
                    <br />
                    <br />
  ...
  <ul>
    ...
    <li><a href="#" title="CARRIER"><span>ONLINE PRICE</span></a></li>
    <li><a href="ABOUT US.aspx"  title="ABOUT US"><span>ABOUT APMC</span></a></li>
    
    <li><a href="Contact US.aspx"  title="CONTACT US"><span>CONTACT US</span></a>&nbsp;</li><li> </li></ul>
</div>
                </td>
            </tr>
        </table>
...
<br />
        ...
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<br />
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        <table style="border-style: inset; border-color: inherit; border-width: thin; left: 365px; width: 265px; position: absolute; top: 195px; background-color: #dfffff">
            <tr>
            ...
            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Names="Times New Roman"
                ForeColor="Red" Height="25px" Width="257px"></asp:Label></td>
            </tr>
        </table>
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        ...
        <br />
        <br />
        <table style="left: 155px; width: 672px; position: absolute; height: 157px; top: 348px;">
            <tr>
                <td colspan="3" style="text-align: center">
                    <span style="color: #0033ff"><span style="color: #0033ff"><span style="color: black">
                        ...
                        | <a href="ABOUT US.aspx"><span style="color: #0000cc">
                                ABOUT US</span><br />
                            </a>

...
<body style="font-weight: bold">
    ...
    <div style="background-color: #efefef">
        ...
        <div id="tabsF">
            <asp:ImageMap ID="ImageMap1" runat="server" Height="107px" 
  ...
  <ul>
    ...
    <li><a href="adminlogin.aspx"><span>ADMIN LOGIN</span></a></li>
        ...
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<table class="style1">
            <tr>
                <td class="style2">
                    <asp:ImageMap ID="ImageMap2" runat="server" Height="153px" 
                        ImageUrl="~/Imanges2/APMC Unjha 4.jpg" Width="180px">
                    </asp:ImageMap>
                </td>
                <td>
                    APMC Unjha<br />
                    In Gazabajar
                    <br />
                    Opp. M.R.S. High Shool<br />
                    Station Road,<br />
                    Unjha - 384170<br />
                    <br />
                    Phone No :- 9924381796<br />
                    Phone No :- 9979620416<br />
                    Fax No :- 02767-326620</td>
            </tr>
        </table>
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        ...
        &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<br />
        <table style="left: 146px; width: 672px; position: absolute; height: 166px; top: 385px;">
            <tr>
                <td colspan="3" style="text-align: center">
                    <span style="color: #0033ff"><span style="color: #0033ff"><span style="color: black">
                        ...
                        <br />
                        <a href="Home.aspx">
                        <span style="color: #0000ff">HOME</span> </a>| <span style="color: #0000cc"><a href="Contact US.aspx">
                            CONTACT US</a></span>
                        ...
                        Style="left: 167px; top: 773px" Text="     Copyright ©2009-2010 JUNJ Softech"
